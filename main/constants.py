...
TASK_CONFIGS = {
    ...
    'tissue_processing':{
        'dataset_dir': DATA_DIR + '/tissue' ,
        'episode_len': 900,
        'camera_names': ['cam_left_wrist' , 'cam_right_wrist' , 'cam_high']
    },

    'grapping':{
        'dataset_dir': DATA_DIR + '/grapping' ,
        'episode_len': 1000,
        'camera_names': ['cam_left_wrist' , 'cam_right_wrist' , 'cam_high']
    },

    'grapping_test':{
        'dataset_dir': DATA_DIR + '/grapping_test' ,
        'episode_len': 2000,
        'camera_names': ['cam_left_wrist' , 'cam_right_wrist' , 'cam_high']
    },

    'grapping_test_one':{
        'dataset_dir': DATA_DIR + '/grapping_test_one' ,
        'episode_len': 1100,
        'camera_names': ['cam_left_wrist' , 'cam_right_wrist' , 'cam_high']
    },
    ...
    'grapping_test_pan':{
        'dataset_dir': DATA_DIR + '/grapping_test_pan' ,
        'episode_len': 2000,
        'camera_names': ['cam_left_wrist' , 'cam_right_wrist' , 'cam_high']
    },
